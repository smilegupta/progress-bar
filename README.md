...
Wonder How we can create a progress bar using HTML CSS JS? If No, this will be the perfect repo for you.

###### **Here is the link of [Live Demo](https://smilegupta.github.io/progress-bar/)**
...
***Glad to see you here! Show some love by [starring](https://github.com/smilegupta/progress-bar/) this repo.***
